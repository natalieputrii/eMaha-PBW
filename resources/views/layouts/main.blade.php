...
<html lang="en">
  ...
  <body>
    <div class="container-fluid">
                ...
                <div class="dropdown float-right">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownMenuButton">
                      <a class="dropdown-item" href="#">
                        <div class="media">
                            <img class="align-self-center mr-3" src="https://rekreartive.com/wp-content/uploads/2018/11/Logo-UKDW-Universitas-Kristen-Duta-Wacana-Original-805x1024.jpg" height="78" width="50" alt="Generic placeholder image">
        ...
        <div class="row vh-100"><!--vertikal height-->
