...
<html lang="en">
  ...
  <body>
      <div class="container-fluid d-flex justify-content-center align-items-center border vh-100">
        <div class="card w-25">
            <div class="card-header bg-primary d-flex justify-content-center"><strong class="text-light">
                FORM REGISTER</strong></div>
            <div class="card-body">
                <form action="/simpan" method="POST">
                    @csrf
                    <div class="form-group">
                        <label>NIK</label>
                        <input type="text" name="nik_user" placeholder="Masukkan NIK" 
